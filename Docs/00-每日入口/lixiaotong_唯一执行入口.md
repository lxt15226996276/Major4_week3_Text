...
> **你以后只打开这 3 个文件**：  
> ① **本文件**（今天干什么） ② [`../02-学员档案/学员能力档案_lixiaotong.md`](../02-学员档案/学员能力档案_lixiaotong.md) ③ [`../01-成长路线/W4-阶段项目-当前.md`](../01-成长路线/W4-阶段项目-当前.md)  
...
## 零、你的真实处境（2026-07-11 · W4 起 · AI 维护）

| 项 | 值 |
|----|-----|
| Unity | 2022.3.62f3c1 · 项目 **`Major4_week3_Text`** |
| 学院 | 元宇宙 · 专业四《Unity开发实战》· **月考纲 U01～U20** |
| SiKi | Unity A计划 · 有效至 **2027-04-15** · 学前必读 **12/20** |
| **现在** | **W4 阶段项目 · 4a 登录链** ← 当前 · [`W4-阶段项目-当前.md`](../01-成长路线/W4-阶段项目-当前.md) |
| P / K / S | **85* / 66 / S2-（过渡）** | **W4 目标 K≥75 · P≥82** |
| **IC 职级** | **L2 · 合格初级** | 相机 **L2** · 详 [`职级全景_L0-F1`](../01-成长路线/职级全景_L0-F1_Unity客户端_lixiaotong.md) |
| **本周硬交付** | **RPG 四阶段 4a→4d**（登录→主场景→战斗→复测） |
| **W3 已归档** | Lab **5/5** · Exam01 补练 ✅ · 见 [`W3-Lab周-归档.md`](../01-成长路线/W3-Lab周-归档.md) |
| **W2 遗留** | Exam04 **开套中断** · Exam08/09 可周末补 · Exam03 P+1 Build 待补 |
...
### 2026-07-11 · **W4 阶段项目 · 4a 登录链** ← 当前

| 任务 | 说明 |
|------|------|
| 核心 | 登录→Loading→主场景 **场景链** · Build 顺序 · 断网 Play |
| 讲义 | [`W4-阶段项目-当前.md`](../01-成长路线/W4-阶段项目-当前.md) **§三 4a** |
| 可复用 | `Exam01_LoginScene` → `Exam01_ServerScene` · MainScene UI 练习 |
| L1 验收 | Build 0→1→2 正确 · 登录 **888888** · 选服 10 条 · 断网 Play |
| ⚠️ **K1** | 「进行下一步」= **只教 · 不改仓库 · 脚本须自己敲** |

### 2026-07-11 · **W3 结周归档**（✅ 已完成）

| 项 | 状态 |
|----|------|
| Lab 5/5 | Animation×2 · Editor · Gameplay · AI ✅ |
| Exam01 补练 | 第 4～6 步 选服链 + MainScene UI ✅ |
| 档案 | P **85** · K **66** · 踩坑 **§二-O W3-1～W6** |
| 归档 | [`W3-Lab周-归档.md`](../01-成长路线/W3-Lab周-归档.md) |

### 2026-07-04 · **W3 Lab D1 · Lab_Animation_01 · 第 0 步**（已归档 ↑）

| 任务 | 说明 |
|------|------|
| 核心 | 建场景 · Plane + 角色 Animator · **不挂旧 Animation 组件** |
| 讲义 | [`Lab_Animation_01.md`](../../Assets/Labs/Stage01_W3/Lab_Animation_01.md) |
| 工作目录 | `Assets/Labs/Stage01_W3/Lab_Animation_01/` |
| 可复用资源 | `Assets/Prefabs/Player.prefab` · `Assets/Animation/Master/` · 参考 `Assets/Animator/Master.controller` |
| 周表 | [`W3-Lab周-归档.md`](../01-成长路线/W3-Lab周-归档.md) |
| L1 验收 | Idle↔Run 参数切换 · Play 肉眼可见 |
| ⚠️ **K1** | 「进行下一步」= **只教 · 不改仓库 · 脚本须自己敲** |
...
| 2026-07-11 | **W3 结周归档** · Lab 5/5 · Exam01 补练 · P **85** K **66** · **开 W4 4a** |
